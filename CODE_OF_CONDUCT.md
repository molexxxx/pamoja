...
violation, email the maintainer at molex@sent.com with "Code of conduct" in the subject
line. Please do not report a violation through a public issue, pull request, or comment.
Reports are read only by the maintainer, who is the sole Community Moderator for this
project.

Include what happened, where it happened, who was involved, and links to anything
relevant. If you are reporting on behalf of someone else, say so, and say whether they
know you are reporting.

Security vulnerabilities are a separate matter and go through the private channel in
...
but communicating to the whole community may be part of a mutually agreed upon
resolution.
...
- **Consequence:** A private, written warning with a time-limited cooldown period
  designed to underscore the seriousness of the situation and give the community members
  involved time to process the incident. The cooldown period may be limited to particular
  communication channels or interactions with particular community members.
- **Repair:** Examples of repair may include making an apology, using the cooldown period
