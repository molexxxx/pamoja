...
<!-- table: reference kit -->
- Rust: [`pamoja-kit`](https://docs.rs/pamoja-kit) ([site](https://pamoja.molex.cloud/docs/reference/rust/pamoja_kit/index.html))
...
- C#: [`Kit`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Kit.html), [`Smoother`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Smoother.html), [`Median`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Median.html), [`Kalman`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Kalman.html), [`Calibration`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Calibration.html), [`Pid`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Pid.html), [`Ramp`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Ramp.html), [`Thermostat`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Thermostat.html), [`Debounce`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Debounce.html), [`Boundary`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Boundary.html), [`Coordinate`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Coordinate.html), [`Geofence`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Geofence.html), [`Window`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Window.html), [`Trend`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Trend.html), [`Surge`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Surge.html), [`Depletion`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Depletion.html), [`Anomaly`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Kit.Anomaly.html)
<!-- end -->
