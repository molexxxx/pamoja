...
- Rust: [`pamoja-lora`](https://docs.rs/pamoja-lora) ([site](https://pamoja.molex.cloud/docs/reference/rust/pamoja_lora/index.html))
...
- C#: [`LoraLink`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraLink.html), [`LoraChannelPlan`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraChannelPlan.html), [`LoraPlanBuilder`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraPlanBuilder.html), [`LoraPlanInfo`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraPlanInfo.html), [`LoraRegion`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraRegion.html), [`LoraDataRate`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraDataRate.html), [`LoraChannelBlock`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraChannelBlock.html), [`LoraChannelSet`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraChannelSet.html), [`LoraSubBand`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraSubBand.html), [`LoraRx2`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraRx2.html), [`LoraBeacon`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraBeacon.html), [`LoraMaxPayload`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraMaxPayload.html), [`LoraPayloadTable`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraPayloadTable.html), [`LoraModulation`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraModulation.html), [`LoraDirection`](https://pamoja.molex.cloud/docs/reference/dotnet/api/Pamoja.Lora.LoraDirection.html)
<!-- end -->
