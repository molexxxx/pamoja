...
| Gateways | The Semtech packet forwarder protocol (PROTOCOL.TXT in `Lora-net/packet_forwarder`), the LoRa Basics Station LNS protocol, RFC 4648 base64, and TS001-1.0.4 for the join accept a network answers with |
