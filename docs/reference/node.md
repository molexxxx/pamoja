...
<div class="door">
<a class="btn btn-warm" href="node/index.html">Open the TypeScript reference</a>
<p>Every <code>@pamoja</code> package, generated by typedoc. It is a site of its own; the tables on this page name what it documents, and every name below opens its page there.</p>
