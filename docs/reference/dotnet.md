...
<div class="door">
<a class="btn btn-warm" href="dotnet/index.html">Open the C# reference</a>
<p>Every <code>Pamoja</code> package, generated by DocFX. It is a site of its own; the tables on this page name what it documents, and every name below opens its page there.</p>
