...
| --- | --- | --- |
| [Device profiles](https://pamoja.molex.cloud/docs/guides/profile.html) | `pamoja.profile` | Named, ready-to-run device profiles from plain data or a JSON manifest, run as a node in every language |
