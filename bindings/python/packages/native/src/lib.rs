...
fn _native(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    #[cfg(feature = "sensors")]
    {
        ...
        m.add_function(wrap_pyfunction!(sensors::ina219_adc_conversion_micros, m)?)?;
        m.add_function(wrap_pyfunction!(sensors::ina219_gain_range_millivolts, m)?)?;
        m.add_class::<sensors_driver::Tmp117Reading>()?;
        m.add_class::<sensors_driver::Tmp117Alerts>()?;
        m.add_class::<sensors_driver::Opt3001Reading>()?;
        m.add_class::<sensors_driver::Ina219Reading>()?;
        m.add_class::<sensors_driver::Ina226Reading>()?;
        m.add_class::<sensors_driver::Ads1115Sample>()?;
        m.add_class::<sensors_driver::Bmp280>()?;
        m.add_class::<sensors_driver::Tmp117>()?;
        m.add_class::<sensors_driver::Opt3001>()?;
        m.add_class::<sensors_driver::Hdc1080>()?;
        m.add_class::<sensors_driver::Ina219>()?;
        m.add_class::<sensors_driver::Ina226>()?;
        m.add_class::<sensors_driver::Ads1115>()?;
        m.add_class::<sensors_driver::Sht3x>()?;
        m.add_class::<sensors_driver::Scd4x>()?;
        m.add_class::<sensors_driver::Ds18b20Thermometer>()?;
        m.add_function(wrap_pyfunction!(sensors_driver::bmp280_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::bmp280_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::bmp280_sim_calibration, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::bmp280_sim_burst, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::bmp280_sim_burst_for, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::tmp117_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::tmp117_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::opt3001_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::opt3001_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::hdc1080_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::hdc1080_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::ina219_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::ina219_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::ina226_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::ina226_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::ads1115_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::ads1115_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::sht3x_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::sht3x_sim_reporting, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::scd4x_sim_part, m)?)?;
        m.add_function(wrap_pyfunction!(sensors_driver::scd4x_sim_reporting, m)?)?;
