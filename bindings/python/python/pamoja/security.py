...
Wraps the native :class:`pamoja._core.DeviceIdentity` with a Python-native
...
from ._core import DeviceIdentity as _NativeDeviceIdentity
from ._core import fingerprint as _native_fingerprint
from ._core import verify as _native_verify
