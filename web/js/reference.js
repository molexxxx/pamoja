(() =>
{
  ...
  const mark =
    '<svg class="pamoja-bar-mark" viewBox="0 0 240 240" width="30" height="30" aria-hidden="true">'
  ...
  bar.innerHTML =
    `<a class="pamoja-bar-brand" href="/">${mark}<span class="pamoja-bar-word">pamoja</span></a>`
