...
#define PAMOJA_GATEWAY_STATION_TEXT_STATION 0

// The firmware a version reports.
#define PAMOJA_GATEWAY_STATION_TEXT_FIRMWARE 1

// The package a version reports.
#define PAMOJA_GATEWAY_STATION_TEXT_PACKAGE 2

// The hardware model a version reports.
#define PAMOJA_GATEWAY_STATION_TEXT_MODEL 3

// What a version says the station can do, such as `gps`.
#define PAMOJA_GATEWAY_STATION_TEXT_FEATURES 4

// The region a configuration names, such as `EU868`.
#define PAMOJA_GATEWAY_STATION_TEXT_REGION 5

// The concentrator a configuration is written for, such as `sx1301/1`.
#define PAMOJA_GATEWAY_STATION_TEXT_HWSPEC 6

// The word a message calls itself on the wire, which is what names a kind this build does
// not model.
#define PAMOJA_GATEWAY_STATION_TEXT_MSGTYPE 7
...
typedef struct PamojaLorawanRelay PamojaLorawanRelay;
...
typedef struct {
  ...
  uint64_t wake_up_start_us;
  // How long that frame holds the air, in microseconds.
  uint64_t wake_up_airtime_us;
...
typedef struct {
  ...
  PamojaLorawanRelayExchange relay;
...
PamojaStatus pamoja_gateway_network_notices(PamojaGatewayNetwork *network,
                                            PamojaGatewayNetworkNotice *out_notices,
                                            uintptr_t capacity,
                                            uintptr_t *out_len);
...
// must be writable.
PamojaStatus pamoja_gateway_network_command(PamojaGatewayNetwork *network,
                                            uint32_t dev_addr,
                                            PamojaGatewayNetworkSlot slot,
                                            const PamojaLorawanMacCommand *commands,
...
PamojaStatus pamoja_gateway_network_trust_command(PamojaGatewayNetwork *network,
                                                  uint32_t dev_addr,
                                                  uint8_t index,
                                                  uint8_t reload_rate,
                                                  uint8_t bucket_size,
...
PamojaGatewayStationMessage *pamoja_gateway_station_message_new(const PamojaGatewayStationFields *fields);
...
//
// `message` must be a live handle, and `out_text` must point to writable storage.
PamojaStatus pamoja_gateway_station_message_text(const PamojaGatewayStationMessage *message,
                                                 uint8_t field,
                                                 PamojaBuffer **out_text);
...
PamojaStatus pamoja_gateway_station_message_set_text(PamojaGatewayStationMessage *message,
                                                     uint8_t field,
                                                     const uint8_t *text,
                                                     uintptr_t text_len);
...
PamojaStatus pamoja_gateway_station_message_set_payload(PamojaGatewayStationMessage *message,
                                                        const uint8_t *bytes,
                                                        uintptr_t bytes_len);
...
//
// `message` must be a live handle, and `bytes` must point to `bytes_len` readable bytes.
PamojaStatus pamoja_gateway_station_message_set_options(PamojaGatewayStationMessage *message,
                                                        const uint8_t *bytes,
                                                        uintptr_t bytes_len);
...
PamojaStatus pamoja_gateway_station_message_add_net_id(PamojaGatewayStationMessage *message,
                                                       uint32_t net_id);
...
PamojaStatus pamoja_gateway_station_message_add_join_range(PamojaGatewayStationMessage *message,
                                                           const PamojaGatewayStationJoinRange *range);
...
PamojaStatus pamoja_gateway_station_message_add_data_rate(PamojaGatewayStationMessage *message,
                                                          const PamojaGatewayStationDataRate *rate);
...
PamojaStatus pamoja_gateway_station_message_add_broadcast(PamojaGatewayStationMessage *message,
                                                          const PamojaGatewayStationBroadcast *frame,
                                                          const uint8_t *pdu,
                                                          uintptr_t pdu_len);
...
PamojaStatus pamoja_gateway_station_message_net_id(const PamojaGatewayStationMessage *message,
                                                   uintptr_t index,
                                                   uint32_t *out_net_id);
...
PamojaStatus pamoja_gateway_station_message_join_range(const PamojaGatewayStationMessage *message,
                                                       uintptr_t index,
                                                       PamojaGatewayStationJoinRange *out_range);
...
PamojaStatus pamoja_gateway_station_message_data_rate(const PamojaGatewayStationMessage *message,
                                                      uintptr_t index,
                                                      PamojaGatewayStationDataRate *out_rate);
...
PamojaStatus pamoja_gateway_station_message_broadcast(const PamojaGatewayStationMessage *message,
                                                      uintptr_t index,
                                                      PamojaGatewayStationBroadcast *out_frame,
                                                      PamojaBuffer **out_pdu);
...
PamojaStatus pamoja_gateway_station_discovery_parse(const uint8_t *text,
                                                    uintptr_t text_len,
                                                    uint8_t *out_router);
...
PamojaStatus pamoja_gateway_station_router_accepted(const uint8_t *router,
                                                    const uint8_t *muxs,
                                                    const uint8_t *uri,
                                                    uintptr_t uri_len,
                                                    PamojaBuffer **out_text);
...
PamojaStatus pamoja_gateway_station_router_refused(const uint8_t *router,
                                                   const uint8_t *error,
                                                   uintptr_t error_len,
                                                   PamojaBuffer **out_text);
...
PamojaStatus pamoja_lorawan_end_device_use_relay(PamojaLorawanEndDevice *device,
                                                 uint8_t on,
                                                 uint8_t *out_taken);
...
PamojaStatus pamoja_lorawan_end_device_relay_mode(PamojaLorawanEndDevice *device,
                                                  uint8_t *out_relaying,
                                                  uint8_t *out_activation,
                                                  uint8_t *out_sync,
                                                  uint32_t *out_wor_counter);
...
//
// `device` must be a live handle and `out_status` writable.
PamojaStatus pamoja_lorawan_end_device_relay_status(PamojaLorawanEndDevice *device,
                                                    PamojaLorawanRelayStatus *out_status);
...
PamojaStatus pamoja_lorawan_end_device_heard_wor_ack(PamojaLorawanEndDevice *device,
                                                     const uint8_t *frame,
                                                     uintptr_t frame_len,
                                                     PamojaLorawanRelayStatus *out_status);
...
//
// `device` must be a live handle and the out pointers writable.
PamojaStatus pamoja_lorawan_end_device_no_wor_ack(PamojaLorawanEndDevice *device,
                                                  uint64_t now_us,
                                                  uint8_t *out_next,
                                                  PamojaLorawanRelayExchange *out_exchange);
...
PamojaStatus pamoja_lorawan_relay_personalized(const PamojaLoraPlan *plan,
                                               const PamojaLorawanSession *session,
                                               const PamojaLorawanDeviceSettings *settings,
                                               uint8_t xtal_accuracy,
                                               uint8_t cad_to_rx,
                                               PamojaLorawanRelay **out_relay);
...
// `plan` and `credentials` must be live handles, `settings` must point to a readable
// [`PamojaLorawanDeviceSettings`], and `out_relay` to a writable pointer.
PamojaStatus pamoja_lorawan_relay_new(const PamojaLoraPlan *plan,
                                      const PamojaLorawanDevice *credentials,
                                      const PamojaLorawanDeviceSettings *settings,
                                      uint8_t xtal_accuracy,
                                      uint8_t cad_to_rx,
...
void pamoja_lorawan_relay_free(PamojaLorawanRelay *relay);
...
PamojaStatus pamoja_lorawan_relay_join(PamojaLorawanRelay *relay,
                                       uint16_t dev_nonce,
                                       uint64_t now_us,
                                       PamojaBuffer **out_frame,
                                       PamojaLorawanTransmission *out_transmission);
...
// that is non-zero, and the out pointers must be writable.
PamojaStatus pamoja_lorawan_relay_send(PamojaLorawanRelay *relay,
                                       uint8_t port,
                                       const uint8_t *payload,
                                       uintptr_t payload_len,
                                       uint8_t confirmed,
...
PamojaStatus pamoja_lorawan_relay_status(const PamojaLorawanRelay *relay,
                                         PamojaLorawanEndDeviceStatus *out_status);
...
PamojaString *pamoja_lorawan_relay_error(PamojaLorawanRelay *relay);
...
//
// `relay` must be a live handle.
PamojaStatus pamoja_lorawan_relay_start(PamojaLorawanRelay *relay,
                                        uint8_t cad_periodicity,
                                        uint8_t default_channel_index,
                                        uint8_t has_second_channel,
                                        uint32_t second_wor_frequency_hz,
                                        uint32_t second_ack_frequency_hz,
                                        uint8_t second_data_rate);
...
//
// `relay` must be a live handle.
void pamoja_lorawan_relay_stop(PamojaLorawanRelay *relay);
...
//
// `relay` must be a live handle.
uint8_t pamoja_lorawan_relay_running(const PamojaLorawanRelay *relay);
...
PamojaStatus pamoja_lorawan_relay_trust(PamojaLorawanRelay *relay,
                                        uint8_t index,
                                        uint32_t dev_addr,
                                        const uint8_t *root_wor_s_key,
                                        uint32_t next_wfcnt,
                                        uint8_t reload_rate,
                                        uint8_t bucket_size);
...
PamojaStatus pamoja_lorawan_relay_next_scan(PamojaLorawanRelay *relay,
                                            uint64_t now_us,
                                            PamojaLorawanScan *out_scan);
...
// `frame` must point to `frame_len` readable bytes.
PamojaStatus pamoja_lorawan_relay_heard_wor(PamojaLorawanRelay *relay,
                                            const PamojaLorawanScan *scan,
                                            const uint8_t *frame,
                                            uintptr_t frame_len,
                                            int16_t rssi_dbm,
                                            int8_t snr_db,
                                            uint64_t ended_us,
                                            PamojaLorawanWake *out_wake);
...
PamojaStatus pamoja_lorawan_relay_heard_uplink(PamojaLorawanRelay *relay,
                                               const uint8_t *frame,
                                               uintptr_t frame_len,
                                               int16_t rssi_dbm,
                                               int8_t snr_db,
...
//
// `relay` must be a live handle.
void pamoja_lorawan_relay_uplink_missed(PamojaLorawanRelay *relay);
...
//
// `relay` must be a live handle and the out pointers writable.
PamojaStatus pamoja_lorawan_relay_forward(PamojaLorawanRelay *relay,
                                          uint64_t now_us,
                                          PamojaBuffer **out_frame,
                                          PamojaLorawanTransmission *out_transmission);
...
uint8_t pamoja_lorawan_relay_forward_due(PamojaLorawanRelay *relay, uint64_t *out_due_us);
...
PamojaStatus pamoja_lorawan_relay_heard_in(PamojaLorawanRelay *relay,
                                           uint8_t window,
                                           const uint8_t *frame,
                                           uintptr_t frame_len,
                                           int8_t snr_db,
...
//
// `relay` must be a live handle and the out pointers writable.
PamojaStatus pamoja_lorawan_relay_nothing_heard(PamojaLorawanRelay *relay,
                                                uint64_t now_us,
                                                uint8_t *out_next,
                                                uint64_t *out_not_before_us);
