...
fn every_region_carries_the_relay_channels_its_section_names() {
    let (sf9, sf7, sf10_wide) = ((9, 125_000), (7, 125_000), (10, 500_000));
    let want: [(&ChannelPlan<'static>, &[(u32, u32, (u8, u32))]); 13] = [
        (
            Region::Eu868.plan(),
            &[(865_100_000, 865_300_000, sf9), (865_500_000, 865_900_000, sf7)],
        ),
        (
            Region::Us915.plan(),
            &[
        ...
        (
            ...
            &[(472_100_000, 485_300_000, sf9), (494_900_000, 505_500_000, sf7)],
        ),
        (
        ...
        (
            Region::Kr920.plan(),
            &[(922_700_000, 922_900_000, sf9), (923_100_000, 923_100_000, sf7)],
        ),
        (
            Region::In865.plan(),
            &[(866_000_000, 866_200_000, sf9), (866_700_000, 866_900_000, sf7)],
        ),
        (
            Region::Ru864.plan(),
            &[(866_100_000, 866_300_000, sf9), (866_500_000, 866_900_000, sf7)],
        ),
    ];
